<template>
    <nav class=" bg-white w-full flex relative justify-between items-center mx-auto px-8 h-20">
        ...
        <div class="inline-flex items-center">
            ...
            <h1 class="text-2xl font-bold px-2">Task Board</h1>
        </div>
            ...
            <div class="inline-block">
                <div class="inline-flex items-center max-w-full ">
                    <button
                        ...
                        type="button">
                        <div class="block flex-grow flex-shrink overflow-hidden">Search your task</div>
                    ...
                    <button class="text-black bg-gray-200 border-0 py-2 px-6 mx-4 focus:outline-none rounded text-md">Workspace Visible</button>
        ...
        <div class="flex-initial">
            <div class="flex justify-end items-center relative">
                ...
                <div class="flex mr-4 items-center">
                    <a class="inline-block py-2 px-10 bg-gray-200 rounded " href="#">
                        <div class="flex items-center relative cursor-pointer whitespace-nowrap">Board</div>
                    </a>
